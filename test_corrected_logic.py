#!/usr/bin/env python3
"""
Test Corrected Global Program Logic
1. Root user Phase-2 এ যাবে, downlines Phase-1 এ থাকবে
2. Root user Slot 2 এ যাবে, downlines Phase-2 এ থাকবে
"""
...
def create_test_user(name_suffix):
    ...
    try:
        ...
        email = f"corrected_test_{name_suffix}_{timestamp}@example.com"
        
        # Create new test user
        user = User(
            uid=f"CORRECTED_{name_suffix}_{timestamp}",
            ...
            name=f"Corrected Test {name_suffix}",
            email=email,
            password="test123456",
            status="active",
            is_activated=True,
...
def simulate_global_join(user_id):
    """Simulate Global Program join with corrected logic"""
    try:
...
def check_phase_progression():
    """Check and trigger phase progression with corrected logic"""
    try:
        ...
        if phase1_users >= 4:
            ...
            if first_user_placement:
                ...
                print("✅ Phase-1 to Phase-2 progression completed (downlines stay in Phase-1)")
        ...
        if phase2_users == 8:
            ...
            if first_user_placement:
                ...
                print("✅ Phase-2 to Slot upgrade completed (downlines stay in Phase-2)")
...
def update_root_position_in_phase1():
    """Update root position in Phase 1 - first downline becomes new root"""
    try:
...
def main():
    print("🚀 Testing Corrected Global Program Logic")
    print("=" * 60)
    print("1. Root user Phase-2 এ যাবে, downlines Phase-1 এ থাকবে")
    print("2. Root user Slot 2 এ যাবে, downlines Phase-2 এ থাকবে")
    print("=" * 60)
    ...
    # Create enough users to test the corrected logic
    for i in range(12):
    ...
    print(f"\n🎉 Corrected Global Program Logic Test Completed!")
    print("=" * 60)
